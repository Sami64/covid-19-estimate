...
class EstimatesModel extends Estimates {
  ...
  factory EstimatesModel.fromJson(Map<String, dynamic> json) {
    return EstimatesModel(
        ...
        impactInfectionsByRequestedTime: json['impact']
            ['infectionsByRequestedTime'],
        impactSevereCasesByRequestedeTime: json['impact']
            ['severeCasesByRequestedTime'],
        impactHospitalBedsByRequestedTime: json['impact']
            ['hospitalBedsByRequestedTime'],
        impactCasesForICUByRequestedTime: json['impact']
            ['casesForICUByRequestedTime'],
        impactCasesForVentilatorsByRequestedTime: json['impact']
            ['casesForVentilatorsByRequestedTime'],
        impactdollarsInFlight: json['impact']['dollarsInFlight'],
        severeCurrentlyInfected: json['severeImpact']['currentlyInfected'],
        severeInfectionsByRequestedTime: json['severeImpact']
            ['infectionsByRequestedTime'],
        severeSevereCasesByRequestedeTime: json['severeImpact']
            ['severeCasesByRequestedTime'],
        severeHospitalBedsByRequestedTime: json['severeImpact']
            ['hospitalBedsByRequestedTime'],
        severeCasesForICUByRequestedTime: json['severeImpact']
            ['casesForICUByRequestedTime'],
        severeCasesForVentilatorsByRequestedTime: json['severeImpact']
            ['casesForVentilatorsByRequestedTime'],
